...
class TestFiboRange(unittest.TestCase):
    ...
    def setUp(self):
        self.positive = FibonacciResultRange(15)
        self.negative = FibonacciResultRange(start_range=-50, end_range=-5)
        self.mixed = FibonacciResultRange(start_range=-30, end_range=30)
